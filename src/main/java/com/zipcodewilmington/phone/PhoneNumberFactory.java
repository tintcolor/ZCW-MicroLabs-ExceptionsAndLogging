...
public final class PhoneNumberFactory {
    ...
    public static PhoneNumber createPhoneNumberSafely(int areaCode, int centralOfficeCode, int phoneLineCode) {
        String number = "(" + Integer.toString(areaCode) + ")-" + Integer.toString(centralOfficeCode) + "-" + Integer.toString(phoneLineCode);

        try {
            return createPhoneNumber(number);
        } catch (InvalidPhoneNumberFormatException e) {
            logger.info("(" + Integer.toString(areaCode) + ")-" + Integer.toString(centralOfficeCode) + "-" + Integer.toString(phoneLineCode) + " is not a valid phone number");
            return null;
        }
    }
